...
class Settings:
    ...
    def __init__(self):
        ...
        self._validation_rules = {
            ...
            'retry_logging_style': {'type': str, 'choices': ['none', 'log_msg', 'inline_block']},
        }
    ...
    def _validate_value(self, key: str, value: Any) -> Any:
        ...
        if 'choices' in rules and value not in rules['choices']:
            raise ValueError(f"Invalid value for {key}: must be one of {rules['choices']}")
    ...
    def va_retry_logging_style(self, value: Literal["none", "log_msg", "inline_block"]) -> None:
    ...
    def retry_logging_style(self, value: Literal["none", "log_msg", "inline_block"]) -> None:
