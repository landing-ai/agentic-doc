...
from agentic_doc.parse import parse_and_save_documents, parse_documents, parse_and_save_document
...
def test_parse_multipage_pdf(multi_page_pdf, results_dir):
    ...
    page_indices = set(grounding.page for chunk in parsed_doc.chunks 
                      for grounding in chunk.grounding
                      if chunk.chunk_type != ChunkType.error)
...
def test_parse_multiple_documents_batch(multi_page_pdf, complex_pdf, sample_image_path, results_dir):
